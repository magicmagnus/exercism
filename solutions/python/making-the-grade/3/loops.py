...
def round_scores(student_scores):
    ...
    return [round(score) for _, score in enumerate(student_scores)]
...
def count_failed_students(student_scores):
    ...
    """
    failed = [score for _, score in enumerate(student_scores) if score <= 40]
    return len(failed)
...
def above_threshold(student_scores, threshold):
    ...
    """
    best = [score for _, score in enumerate(student_scores) if score >= threshold]
