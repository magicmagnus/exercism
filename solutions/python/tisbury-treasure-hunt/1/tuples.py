...
def compare_records(azara_record, rui_record):
    ...
    """
    a_coords = convert_coordinate(azara_record[1])
    r_coords = rui_record[1]
    
    return a_coords[0] == r_coords[0] and a_coords[1] == r_coords[1]
...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        res += f"('{record[0]}', '{record[2]}', ('{record[3][0]}', '{record[3][1]}'), '{record[4]}')\n"
